...
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports o_clk]
...
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports o_latch]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports o_oe_]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports o_data]
